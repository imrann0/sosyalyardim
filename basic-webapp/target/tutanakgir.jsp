                   ...
                   <div class="card-header d-flex justify-content-center">
                    ...
                    <form action="saveBolge" method="post">
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label class="form-heading">Adı</label>
                                <input type="text" class="form-control" name="bolgekod" placeholder="" required>
                              </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-center"> <!-- Butonu ortalamak için d-flex ve justify-content-center sınıflarını kullanıyoruz -->
					      <button type="submit" class="btn btn-info">Devam</button>
					    </div>
                    </form>
                </div>
                <!-- Modal -->
