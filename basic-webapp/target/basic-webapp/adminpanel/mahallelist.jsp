      ...
      <div class="container">
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header d-flex justify-content-center"">
                        <h3 class="card-title">Mahalle Girişi Bilgileri</h3>
                    </div>
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-center">
                    <h3 class="card-title font-weight-bold">MAHALLE LİSTESİ</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td><a href="mahallegir.jsp"><button type="submit" class="btn btn-info">Düzenle</button></a>
                      </td>
