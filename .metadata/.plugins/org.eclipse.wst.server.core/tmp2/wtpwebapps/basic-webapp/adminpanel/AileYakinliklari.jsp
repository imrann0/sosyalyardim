								...
								<form>
									<div class="card-body">
										...
										<div class="form-group row m-2">
											...
											<label class="col-sm-2 col-form-label">Müracaat No -
												Müracaat Eden:</label>
											<div class="col-sm-4">**</div>
								...
								<form>
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<label class="col-sm-2 col-form-label">Doğum Tarihi </label>
											<div class="col-sm-4">
												<input type="date" class="form-control" id="yKurum">
											</div>


											<label  class="col-sm-2 col-form-label">Açıklama
											</label>
											<div class="col-sm-4">
										...
										<div class="form-group row ">
											...
											<label class="col-sm-2 col-form-label"> Eğitim
												Durumu:</label>
											<div class="col-sm-4">
												<select class="form-control">
													<option>--</option>
          ...
          <div class="col-12">
		            <div class="card custom-datatable">
		                ...
		                <div class="card-header d-flex justify-content-center">
		                    <h3 class="card-title font-weight-bold">Aile Yakınlıkları<h3>                	                
						</div><!-- /.card-header -->
		                <div class="card-body">
